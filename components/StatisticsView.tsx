                                        ...
                                        >
                                            ...
                                            <div className="flex-1">
                                                ...
                                                {alert.count !== undefined && (
                                                    <p className="text-2xl font-black mt-1">{alert.count}</p>
                                                )}
                                            </div>
                                        </div>
                                    );
                ...
                <div className="mb-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-2xl p-6 shadow-lg text-white">
                        <div className="flex items-center justify-between mb-3">
                            ...
                            <div className="text-right">
                                <p className="text-emerald-100 text-xs font-black uppercase tracking-wider">Disponibilidad</p>
                                <p className="text-5xl font-black mt-1">{availabilityRates.vehicleAvailability.toFixed(1)}%</p>
                            </div>
                        </div>
                    ...
                    <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl p-6 shadow-lg text-white">
                        <div className="flex items-center justify-between mb-3">
                            ...
                            <div className="text-right">
                                <p className="text-purple-100 text-xs font-black uppercase tracking-wider">Ratio Personal/Vehículo</p>
                                <p className="text-5xl font-black mt-1">{availabilityRates.personnelVehicleRatio.toFixed(1)}</p>
                            </div>
                        </div>
                    ...
                    <div className="bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-2xl p-6 shadow-lg text-white">
                        <div className="flex items-center justify-between mb-3">
                            ...
                            <div className="text-right">
                                <p className="text-cyan-100 text-xs font-black uppercase tracking-wider">Cobertura Total</p>
                                <p className="text-5xl font-black mt-1">{SECTORS.length}</p>
                            </div>
                        </div>
                            ...
                            <table className="w-full">
                                <thead>
                                    <tr className="bg-slate-800 text-white">
                                        <th className="px-4 py-3 text-left text-xs font-black uppercase tracking-wider border-r border-slate-700"></th>
                                        <th className="px-4 py-3 text-center text-xs font-black uppercase tracking-wider border-r border-slate-700">Carros</th>
                                        <th className="px-4 py-3 text-center text-xs font-black uppercase tracking-wider">Motos</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr className="bg-slate-100 border-t-2 border-slate-300">
                                        <td className="px-4 py-3 text-sm font-black text-slate-900 uppercase border-r border-slate-300">Total</td>
                                        <td className="px-4 py-3 text-center text-lg font-black text-[#004b93] border-r border-slate-300">{totalCarros}</td>
                                        <td className="px-4 py-3 text-center text-lg font-black text-[#004b93]">{totalMotos}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full">
                                <thead>
                                    <tr className="bg-slate-800 text-white">
                                        <th className="px-4 py-3 text-left text-xs font-black uppercase tracking-wider border-r border-slate-700"></th>
                                        <th className="px-4 py-3 text-center text-xs font-black uppercase tracking-wider border-r border-slate-700">Choferes</th>
                                        <th className="px-4 py-3 text-center text-xs font-black uppercase tracking-wider border-r border-slate-700">Motorizados</th>
                                        <th className="px-4 py-3 text-center text-xs font-black uppercase tracking-wider border-r border-slate-700">Serenos</th>
                                        <th className="px-4 py-3 text-center text-xs font-black uppercase tracking-wider bg-yellow-400 text-slate-900">Total</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {SECTORS.map((sector, index) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-4 py-2.5 text-center text-sm font-black text-slate-900 bg-yellow-50">{personnelStats[sector]?.total || 0}</td>
                                        </tr>
                                    ))}
                                    <tr className="bg-slate-100 border-t-2 border-slate-300">
                                        <td className="px-4 py-3 text-sm font-black text-slate-900 uppercase border-r border-slate-300">Total</td>
                                        <td className="px-4 py-3 text-center text-lg font-black text-[#00a19b] border-r border-slate-300">{totalChoferes}</td>
                                        <td className="px-4 py-3 text-center text-lg font-black text-[#00a19b] border-r border-slate-300">{totalMotorizados}</td>
                                        <td className="px-4 py-3 text-center text-lg font-black text-[#00a19b] border-r border-slate-300">{totalSerenos}</td>
                                        <td className="px-4 py-3 text-center text-xl font-black text-slate-900 bg-yellow-100">{totalPersonnel}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                ...
                <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl p-4 shadow-lg">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-blue-100 text-xs font-black uppercase tracking-wider">Carros Patrullando</p>
                                <p className="text-white text-3xl font-black mt-1">{totalCarros}</p>
                            </div>
                    ...
                    <div className="bg-gradient-to-br from-violet-500 to-violet-600 rounded-xl p-4 shadow-lg">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-violet-100 text-xs font-black uppercase tracking-wider">Motos Patrullando</p>
                                <p className="text-white text-3xl font-black mt-1">{totalMotos}</p>
                            </div>
                    ...
                    <div className="bg-gradient-to-br from-teal-500 to-teal-600 rounded-xl p-4 shadow-lg">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-teal-100 text-xs font-black uppercase tracking-wider">Personal Operativo</p>
                                <p className="text-white text-3xl font-black mt-1">{totalPersonnel}</p>
                            </div>
                    ...
                    <div className="bg-gradient-to-br from-amber-500 to-amber-600 rounded-xl p-4 shadow-lg">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-amber-100 text-xs font-black uppercase tracking-wider">Sectores Activos</p>
                                <p className="text-white text-3xl font-black mt-1">{SECTORS.length}</p>
                            </div>
