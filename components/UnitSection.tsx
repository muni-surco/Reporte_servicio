    ...
    <div className="bg-white rounded-xl shadow-sm border border-slate-200 mb-5">
      <div className={`${colorConfig.bgHeader} px-4 py-2.5 border-b ${colorConfig.borderHeader} flex items-center justify-between rounded-t-xl`}>
        <div className="flex items-center gap-3">
          ...
          <span className="bg-amber-50 text-amber-700 border border-amber-200 px-2.5 rounded-full text-[10px] font-bold uppercase tracking-tighter shadow-sm">
      ...
      <div className="p-3 bg-slate-50/30">
        {units.length === 0 ? (
          <div className="text-center py-8 text-slate-300 text-[10px] italic font-bold uppercase tracking-widest">No hay registros en esta sección</div>
        ) : (
