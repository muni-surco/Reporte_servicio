  ...
  return (
    <div className="relative w-full" ref={containerRef}>
      <input
        ...
        disabled={disabled}
        className={`w-full border ${error ? 'border-red-500 ring-1 ring-red-200 bg-red-50' : 'border-slate-300'} rounded px-2 py-1 text-[11px]  h-[32px] focus:ring-2 focus:ring-blue-500 focus:outline-none transition-all shadow-sm text-slate-800 ${disabled ? 'bg-slate-100 cursor-not-allowed' : ''} ${className}`}
      />
